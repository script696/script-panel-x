...
const BotColorThemeConstructor: FC<BotColorThemeConstructorProps> = ({ reloadBotFrame }) => {
  ...
  return (
    <EditableRow title={t("admin.bot.constructor.theme.title")} onEdit={handleOpen}>
      <Box mb={2}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={4} display={"flex"} flexDirection={"column"} alignItems={"center"} rowGap={1}>
            <Typography variant={"h6"}>{t(BG_TO_LABEL_MAP["bgMain"])}</Typography>
            <Box sx={{ background: colorTheme["bgMain"] }} width={50} height={50} borderRadius={"50%"} />
          </Grid>
          <Grid item xs={4} display={"flex"} flexDirection={"column"} alignItems={"center"} rowGap={1}>
            <Typography variant={"h6"}>{t(BG_TO_LABEL_MAP["bgDark"])}</Typography>
            <Box sx={{ background: colorTheme["bgDark"] }} width={50} height={50} borderRadius={"50%"} />
          </Grid>
          <Grid item xs={4} display={"flex"} flexDirection={"column"} alignItems={"center"} rowGap={1}>
            <Typography variant={"h6"}>{t(BG_TO_LABEL_MAP["bgLight"])}</Typography>
      ...
      <Box>
        ...
        <Grid container spacing={2}>
          <Grid item xs={4} display={"flex"} flexDirection={"column"} alignItems={"center"} rowGap={1}>
            <Typography variant={"h6"}>{t(BG_TO_LABEL_MAP["primaryColor"])}</Typography>
            <Box sx={{ background: colorTheme["primaryColor"] }} width={50} height={50} borderRadius={"50%"} />
          </Grid>
          <Grid item xs={4} display={"flex"} flexDirection={"column"} alignItems={"center"} rowGap={1}>
            <Typography variant={"h6"}>{t(BG_TO_LABEL_MAP["secondaryColor"])}</Typography>
            <Box sx={{ background: colorTheme["secondaryColor"] }} width={50} height={50} borderRadius={"50%"} />
          </Grid>
          <Grid item xs={4} display={"flex"} flexDirection={"column"} alignItems={"center"} rowGap={1}>
            <Typography variant={"h6"}>{t(BG_TO_LABEL_MAP["alternateColor"])}</Typography>
