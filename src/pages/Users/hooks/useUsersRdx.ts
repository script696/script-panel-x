...
import { getUsersThunk, removeUsersThunk } from "app/store/reducers/users/usersThunk";
...
export const useUsersRdx = () => {
  const { openEditUserModal, toggleDeleteUserModal, deleteUsers, changeSelectedRows } = usersSlice.actions;
