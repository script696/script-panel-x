...
import { getProductsThunk, removeProductsThunk } from "app/store/reducers/products/productThunk";
import { useAppDispatch, useAppSelector } from "app/store";
import { productsSlice } from "app/store/reducers/products/productsSlice";
import { useEffect } from "react";

export const useProductsRdx = () => {
  const { openEditProductModal, toggleDeleteProductModal, deleteProducts, changeSelectedRows } = productsSlice.actions;
